...
export async function startPromptTelemetry(args) {
    if (!otelEnabled()) {
    ...
    let ended = false;
    const startChildToolSpan = (toolName, toolCallId) => {
    ...
    const completeChildToolSpan = (toolName, success, details, toolCallId) => {
