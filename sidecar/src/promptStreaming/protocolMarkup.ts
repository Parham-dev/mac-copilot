export const protocolTagNames = ["function_calls", "system_notification", "invoke", "parameter", "function", "function_"] as const;

const inlineProtocolTagNames = new Set<string>(["function", "function_"]);
