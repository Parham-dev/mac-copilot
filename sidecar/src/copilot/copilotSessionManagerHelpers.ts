...
export type AllowedToolSelection = {
  requestedAllowedTools: string[] | null;
  nativeAvailableTools: string[] | null;
};

export function normalizeAllowedTools(allowedTools?: string[] | null) {
...
function isLikelyMCPToolName(toolName: string) {
  return toolName === "fetch" || toolName.startsWith("fetch_");
}

export function selectAllowedTools(allowedTools?: string[] | null): AllowedToolSelection {
...
export function normalizeStringListEnv(name: string) {
...
export function sameAllowedTools(lhs: string[] | null, rhs: string[] | null) {
...
export function sameStringList(lhs: string[] | null, rhs: string[] | null) {
  if (lhs === null && rhs === null) {
    return true;
  }
  if (!Array.isArray(lhs) || !Array.isArray(rhs)) {
...
export function normalizeChatKey(chatID?: string, projectPath?: string) {
...
export function buildSessionIdentifier(chatKey: string) {
